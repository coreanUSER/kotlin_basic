...
class MovieKotiln {
    ...
    class ActorKotlin {
        ...
        // 출연작
        var actedMovies: List<MovieKotiln?>? = null
    }

    // 배우 캐스팅 후보를 반환하는 함수
    // 전달받은 영화 목록 중 제목에 "도시" 문자열이 있는 영화만 조사
    // 주연배우 목록에서 여상 20대, 작품수 5개 이상이면 추천
    // 조연배우 목록에서 남자이고 30대, 출연작품 중 공포 장르가 3개 이상인 경우 추천
    fun casting(movies: List<MovieKotiln?>?): MutableList<ActorKotlin> {
